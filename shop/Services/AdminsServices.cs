...
namespace shop.Services
{
    public class AdminsServices:IAdminServices
    {
        ...
        {
            return await _context.admins.OrderBy(g => g.name).ToListAsync();
        }

        public async Task<Admin> GetById(int id)
        {
            return await _context.admins.SingleOrDefaultAsync(g => g.Id == id);
        }

        public Task<bool> IsvalidGenre(int id)
        {
            return _context.admins.AnyAsync(g => g.Id == id);
        }
        ...
        public Admin Authenticate(string Email, string Password)
        {
            ...
            return  _context.admins.SingleOrDefault(u => u.Email == Email && u.Password == Password);
        }
    }
}
